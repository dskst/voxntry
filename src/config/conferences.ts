...
export const conferences: ConferenceConfig[] = [
  {
    ...
    password: validateEnvVar('CONFERENCE_DEMO_CONF_PASSWORD', process.env.CONFERENCE_DEMO_CONF_PASSWORD),
    spreadsheetId: validateEnvVar('NEXT_PUBLIC_DEMO_SPREADSHEET_ID', process.env.NEXT_PUBLIC_DEMO_SPREADSHEET_ID),
    sheetConfig: {
      sheetName: 'シート1',
      startRow: 2,
      columns: {
